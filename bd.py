...
con = mysql.connector.connect(
    host='localhost', database='mySQL', user='Hernane', password='IoT000#$$')
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("topico_sensor_temperatura1")
...
def on_message(client, userdata, msg):
    ...
    cursor = con.cursor()
    cursor.execute("INSERT INTO dadosIoT (mensagem) VALUES ('{}')".format(
